	...
	VALUES (
		...
		'$2y$10$7kxBENHyWlf2EZj8NgiEUuJqbsKGESg681F5OG5iq2TONrVxy83Se', -- Senha = "1234", se nao funcionar gerar outra senha como diz no final
		'administrador',
		1
	);

	-- gerar senha no terminal do xampp:
	-- php -r "echo password_hash('senha aqui', PASSWORD_DEFAULT) . PHP_EOL;"
